...
const secureCookie = (user) => {
  ...
  const encrypted = CryptoJS.AES.encrypt(
   ...
   //if you're using dbAuth v7.6.2, you have to change the cookie name. You can comment out the line below and make the next line as comment. 8911 is the api port. You can change it accordingly.
